...
import com.portingdeadmods.spaceploitation.content.blockentity.CreativePowerBlockEntity;
...
public final class MJBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, Spaceploitation.MODID);
