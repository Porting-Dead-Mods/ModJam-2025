package com.portingdeadmods.spaceploitation.screen;
...
public class ExampleScreen extends AbstractContainerScreen<ExampleMenu> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Spaceploitation.MODID, "textures/gui/example.png");
