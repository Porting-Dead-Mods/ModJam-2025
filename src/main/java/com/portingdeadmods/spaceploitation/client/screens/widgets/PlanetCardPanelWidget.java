...
import com.portingdeadmods.spaceploitation.networking.PlanetCardWidgetSetSlotPositionPayload;
...
public class PlanetCardPanelWidget extends PanelWidget {
    public static final ResourceLocation WIDGET_SPRITE = Spaceploitation.rl("widgets/widget_planet_card_right");
