...
import com.portingdeadmods.spaceploitation.client.screens.widgets.CustomEnergyBarWidget;
...
public class EnergyBusScreen extends AbstractContainerScreen<EnergyBusMenu> {
    ...
    protected void init() {
        super.init();
        if (BACKGROUND == null) {
            BACKGROUND = ScreenTextureBuilder.create(Spaceploitation.MODID, "energy_bus")
                    .buildAndCache();
        }
