package com.portingdeadmods.spaceploitation.client.renderers.blockentity;
...
import com.portingdeadmods.spaceploitation.client.renderers.PlanetModel;
...
@EventBusSubscriber(modid = Spaceploitation.MODID, value = Dist.CLIENT) // munted
public class PlanetSimulatorBlockEntityRenderer implements BlockEntityRenderer<PlanetSimulatorBlockEntity> {
    ...
    private ResourceLocation getTexture(PlanetSimulatorBlockEntity be)
    {
        ...
        return planetComponent.planetType().get().projectionTexture()
                .orElse(Spaceploitation.rl("textures/planet/ass.png"));
    }
