package com.portingdeadmods.spaceploitation.client.models;
...
public class CompressorModel extends Model {
    public static final Material MATERIAL = new Material(InventoryMenu.BLOCK_ATLAS, Spaceploitation.rl("entity/compressor"));
    public static final Material PRESS_MATERIAL = new Material(InventoryMenu.BLOCK_ATLAS, Spaceploitation.rl("entity/compressor_press"));
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Spaceploitation.rl("compressor"), "main");
    public static final ModelLayerLocation PRESS_LAYER_LOCATION = new ModelLayerLocation(Spaceploitation.rl("compressor_press"), "main");
