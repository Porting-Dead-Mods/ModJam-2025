...
public class MultiblockJEIPlugin implements IModPlugin {
    ...
    public ResourceLocation getPluginUid() {
        return ResourceLocation.fromNamespaceAndPath(Spaceploitation.MODID, "jei_plugin");
    }
...
//        dustStack.set(DataComponents.CUSTOM_NAME, Component.translatable("spaceploitation.jei.grinding_output").withStyle(ChatFormatting.RESET));
//
//        ItemStack oreStack = new ItemStack(Items.COBBLESTONE);
//        oreStack.set(DataComponents.CUSTOM_NAME, Component.translatable("spaceploitation.jei.grinding_input").withStyle(ChatFormatting.RESET));
//
//        registration.addRecipes(RecipeTypes.CRAFTING, Collections.singletonList(new RecipeHolder<>(
//                ResourceLocation.fromNamespaceAndPath(Spaceploitation.MODID, "grinding_example"),
//                new ShapelessRecipe(
//                        "grinding",
