...
public class PlanetSimulatorCategory extends AbstractRecipeCategory<PlanetSimulatorRecipe> {
    public static final ResourceLocation RECIPE_ARROW_VERTICAL_SPRITE = Spaceploitation.rl("textures/gui/sprites/recipe_arrow_vertical.png");
    public static final ResourceLocation RECIPE_ARROW_VERTICAL_FILLED_SPRITE = Spaceploitation.rl("textures/gui/sprites/recipe_arrow_filled_vertical.png");

    public static final RecipeType<PlanetSimulatorRecipe> TYPE = RecipeType.create(Spaceploitation.MODID, "planet_simulator", PlanetSimulatorRecipe.class);
    @org.jetbrains.annotations.NotNull
    private final IGuiHelper guiHelper;

    public PlanetSimulatorCategory(IGuiHelper guiHelper) {
        super(TYPE, Component.translatable("jei.spaceploitation.category.planet_simulator"), guiHelper.createDrawableItemLike(MJBlocks.PLANET_SIMULATOR_CONTROLLER), 176, 126);
