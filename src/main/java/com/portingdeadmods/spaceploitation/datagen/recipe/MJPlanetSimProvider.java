package com.portingdeadmods.spaceploitation.datagen.recipe;

import com.portingdeadmods.spaceploitation.Spaceploitation;
import com.portingdeadmods.spaceploitation.data.PlanetType;
import com.portingdeadmods.spaceploitation.datagen.recipe.builder.PlanetSimulatorRecipeBuilder;
...
public class MJPlanetSimProvider extends RecipeProvider {
    ...
    private ResourceKey<PlanetType> createKey(String path) {
        return ResourceKey.create(MJRegistries.PLANET_TYPE_KEY, Spaceploitation.rl(path));
    }
