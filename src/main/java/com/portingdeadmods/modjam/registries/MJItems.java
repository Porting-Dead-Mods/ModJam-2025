...
public final class MJItems {
    ...
    public static final DeferredItem<UpgradeItem> ENERGY_UPGRADE = ITEMS.register("upgrade_energy", () -> new UpgradeItem(ResourceKey.create(MJRegistries.UPGRADE_TYPE_KEY, Modjam.rl("energy")), new Item.Properties()));

    public static final DeferredItem<UpgradeItem> SPEED_UPGRADE = ITEMS.register("upgrade_speed", () -> new UpgradeItem(ResourceKey.create(MJRegistries.UPGRADE_TYPE_KEY, Modjam.rl("speed")), new Item.Properties()));

    public static final DeferredItem<UpgradeItem> LUCK_UPGRADE = ITEMS.register("upgrade_luck", () -> new UpgradeItem(ResourceKey.create(MJRegistries.UPGRADE_TYPE_KEY, Modjam.rl("luck")), new Item.Properties()));
