...
//        }));
//
        shadersEvent.registerShader(compileShader(shadersEvent, ResourceLocation.fromNamespaceAndPath(Modjam.MODID, "planet_projection"), DefaultVertexFormat.POSITION_TEX_COLOR_NORMAL), (shaderInstance -> {
            if (shaderInstance != null) {
